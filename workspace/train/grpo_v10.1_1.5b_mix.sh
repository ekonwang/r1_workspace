...
OUTPUT_DIR='./outputs/v10.1-mix-grpo-1.5b'
MODEL=.temp/models/Qwen_Qwen2.5-1.5B-Instruct
REWARD=workspace/reward/reward_func_relax_v10.1.py
...
export GROUP_V2_0501_CONSTRASTIVE_MODE=1
