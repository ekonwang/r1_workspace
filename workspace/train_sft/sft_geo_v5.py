...
from trainer import Qwen2VLGRPOTrainer, Qwen2VLGRPOVLLMTrainer, Qwen2VLSFTTrainer
...
def main(script_args, training_args, model_args):
    ...
    dataset = utils.load_jsonl(script_args.dataset_name)
    dataset = [make_sft_example(d) for d in dataset]
